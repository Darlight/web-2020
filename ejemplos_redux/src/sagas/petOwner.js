...
function* fetchOwners(action) {
    try {
        ...
        yield put(actions.failFetchingPetOwners('Error en la conexión'));
    }
}
...
function* removeOwners(action) {
    ...
    try {
        ...
        console.log(error)
        yield put(actions.failRemovingPetOwner('Error en la conexión'));
    }
}
...
function* addOwners(action) {
    try {
        ...
        console.log(error)
        yield put(actions.failAddingPetOwner('Error en la conexión'));
    }
}
